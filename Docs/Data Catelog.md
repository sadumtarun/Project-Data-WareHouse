...
|------------------|---------------|-----------------------------------------------------------------------------------------------|
| customer_keys     | INT           | Surrogate key uniquely identifying each customer record in the dimension table.               |
| customer_id      | INT           | Unique numerical identifier assigned to each customer.                                        |
| customer_number  | NVARCHAR(50)  | Alphanumeric identifier representing the customer, used for tracking and referencing.         |
| firstname       | NVARCHAR(50)  | The customer's first name.                                                                    |
| lastname        | NVARCHAR(50)  | The customer's last name.                                                                     |
| country          | NVARCHAR(50)  | The country of residence for the customer                                                     |
| customer_marital_status   | NVARCHAR(50)  | The marital status of the customer                                                           |
...
| start_dt            | DATE          | The date when the product became available for sale or use, stored in|
...
| customer_keys    | INT           | Surrogate key linking the order to the customer dimension table.                              |
